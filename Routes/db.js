...
const config = {
  user: 'nkdtpihfbhjdjk',
  database: 'd880or9b563jki',
  password: 'f0e1b155c789bb55e992293f71035cc3a9fe6fce5fb3a04e923cd24687b539d4',
  port: 5432,
...
function updatePostgress(arr) {
  pool.connect(function (err, conn, done) {
    ...
    conn.query(
        ...
        'INSERT INTO student ("CaseNumber", "Status") VALUES ($1,$2);', arr,
        function(err, result) {
